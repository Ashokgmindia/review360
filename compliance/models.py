...
class AuditLog(models.Model):
    ...
    college = models.ForeignKey("iam.College", on_delete=models.CASCADE, related_name="audit_logs", null=True, blank=True)
...
class ArchiveRecord(models.Model):
    college = models.ForeignKey("iam.College", on_delete=models.CASCADE, related_name="archive_records", null=True, blank=True)
    table_name = models.CharField(max_length=50)
