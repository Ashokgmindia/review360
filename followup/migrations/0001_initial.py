...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['college', 'academic_year'], name='followup_fo_college_7c60ac_idx'), models.Index(fields=['student', 'status'], name='followup_fo_student_783059_idx'), models.Index(fields=['teacher', 'session_datetime'], name='followup_fo_teacher_202bdc_idx'), models.Index(fields=['status'], name='followup_fo_status_f2b3ec_idx')],
            },
        ),
    ]
